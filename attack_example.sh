...
python poisoning_attack.py --target_class 0 --dataset cifar10 --encoder xception --seed_amount 1000 --attack_type clean_label --check_mia False
...
python poisoning_attack.py --target_class 0 --dataset cifar10 --encoder xception --seed_amount 1000 --attack_type dirty_label --check_mia False